preferences {
    input("url",   "url",	title: "Camera URL",	description: "Full Image URL", autoCorrect:false)}

metadata {
definition (name: "Cam Static Image Handler", namespace: "Cam Static Image Handler", author: "Drew/Dlasher") {
